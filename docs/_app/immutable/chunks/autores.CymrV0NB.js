import{w as A,h as H,at as S,a4 as w,au as D}from"./runtime.C3JS33kB.js";import{g as C,j as y,k as E,n as O,l as q}from"./disclose-version.BePWVN5T.js";function G(e,a){if(a){const r=document.body;e.autofocus=!0,A(()=>{document.activeElement===r&&e.focus()})}}function B(e,a,r,l){var d=e.__attributes??(e.__attributes={});H&&(d[a]=e.getAttribute(a),a==="src"||a==="srcset"||a==="href"&&e.nodeName==="LINK")||d[a]!==(d[a]=r)&&(a==="style"&&"__styles"in e&&(e.__styles={}),a==="loading"&&(e[S]=r),r==null?e.removeAttribute(a):typeof r!="string"&&_(e).includes(a)?e[a]=r:e.setAttribute(a,r))}function F(e,a,r,l,d=!1,u=!1,j=!1){var s=a||{},P=e.tagName==="OPTION";for(var h in a)h in r||(r[h]=null);var T=_(e),R=e.__attributes??(e.__attributes={}),f=[];for(const o in r){let i=r[o];if(P&&o==="value"&&i==null){e.value=e.__value="",s[o]=i;continue}var p=s[o];if(i!==p){s[o]=i;var g=o[0]+o[1];if(g!=="$$"){if(g==="on"){const c={},m="$$"+o;let n=o.slice(2);var v=q(n);if(C(n)&&(n=n.slice(0,-7),c.capture=!0),!v&&p){if(i!=null)continue;e.removeEventListener(n,s[m],c),s[m]=null}if(i!=null)if(v)e[`__${n}`]=i,E([n]);else{let b=function(M){s[o].call(this,M)};a?s[m]=y(n,e,b,c):f.push([o,i,()=>s[m]=y(n,e,b,c)])}}else if(o==="style"&&i!=null)e.style.cssText=i+"";else if(o==="autofocus")G(e,!!i);else if(o==="__value"||o==="value"&&i!=null)e.value=e[o]=e.__value=i;else{var t=o;d||(t=O(t)),i==null&&!u?(R[o]=null,e.removeAttribute(o)):T.includes(t)&&(u||typeof i!="string")?e[t]=i:typeof i!="function"&&(H&&(t==="src"||t==="href"||t==="srcset")||B(e,t,i))}o==="style"&&"__styles"in e&&(e.__styles={})}}}return a||A(()=>{if(e.isConnected)for(const[o,i,c]of f)s[o]===i&&c()}),s}var k=new Map;function _(e){var a=k.get(e.nodeName);if(a)return a;k.set(e.nodeName,a=[]);for(var r,l=w(e),d=Element.prototype;d!==l;){r=D(l);for(var u in r)r[u].set&&a.push(u);l=w(l)}return a}const I=[{id:"j-k-rowling",nome:"J.K. Rowling",imagem:"https://www.cnnbrasil.com.br/wp-content/uploads/sites/12/2024/04/GettyImages-950041970-e1712065084538.jpg",biografia:`
# J.K. Rowling
...
> *"As palavras são, na minha nada humilde opinião, nossa fonte mais inesgotável de magia."* - J.K. Rowling
        `},{id:"j-r-r-tolkien",nome:"J.R.R. Tolkien",imagem:"https://static.wixstatic.com/media/064821_b9fda45205e4495cac3a0d35ba514e86~mv2.jpeg/v1/fill/w_568,h_320,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/064821_b9fda45205e4495cac3a0d35ba514e86~mv2.jpeg",biografia:`
# J.R.R. Tolkien
...
> *"Nem todos os que vagam estão perdidos."* - J.R.R. Tolkien
        `},{id:"george-r-r-martin",nome:"George R.R. Martin",imagem:"https://musicaecinema.com/wp-content/uploads/2024/11/george-rr-martin-spin-off-arya-stark-1024x576.webp",biografia:`
# George R.R. Martin
...
> *"Um leitor vive mil vidas antes de morrer. O homem que nunca lê vive apenas uma."* - George R.R. Martin
        `},{id:"stephen-king",nome:"Stephen King",imagem:"https://i.guim.co.uk/img/media/56be7b100f9704b507dbac33715297ae2f5bd11e/0_491_4024_2414/master/4024.jpg?width=1200&height=900&quality=85&auto=format&fit=crop&s=79a480ee23f06486c53dbc27894dc3bd",biografia:`
# Stephen King
...
> *"The most terrible monsters are human."* - Stephen King
    `},{id:"isaac-asimov",nome:"Isaac Asimov",imagem:"https://cdn.britannica.com/82/195182-050-97684526/Isaac-Asimov-1979.jpg",biografia:`
# Isaac Asimov
...
Asimov was a strong proponent of science and reason. He often wrote about the future and the potential dangers of technology. He was also a gifted storyteller, and his books are often filled with humor and wit.
    `},{id:"agatha-christie",nome:"Agatha Christie",imagem:"https://www.adazing.com/wp-content/uploads/2024/03/0008.png",biografia:`
# Agatha Christie
...
Christie's novels have been adapted for film, television, and theatre. She is one of the best-selling authors of all time, and her books continue to be popular today.
  `},{id:"jane-austen",nome:"Jane Austen",imagem:"https://kindersleysocial.ca/wp-content/uploads/2021/09/jane-austen.jpg",biografia:`
# Jane Austen
...
Austen's novels often explore themes of love, marriage, and social class. Her characters are complex and believable, and her writing is both humorous and thought-provoking.
  `},{id:"william-shakespeare",nome:"William Shakespeare",imagem:"https://hips.hearstapps.com/hmg-prod/images/william-shakespeare-194895-1-402.jpg?crop=1.00xw:1.00xh;0,0&resize=1200:*",biografia:`
# William Shakespeare
...
Shakespeare's plays explore a wide range of human emotions and experiences. His characters are complex and memorable, and his language is both beautiful and powerful.
  `},{id:"fyodor-dostoevsky",nome:"Fyodor Dostoevsky",imagem:"https://upload.wikimedia.org/wikipedia/commons/7/78/Vasily_Perov_-_%D0%9F%D0%BE%D1%80%D1%82%D1%80%D0%B5%D1%82_%D0%A4.%D0%9C.%D0%94%D0%BE%D1%81%D1%82%D0%BE%D0%B5%D0%B2%D1%81%D0%BA%D0%BE%D0%B3%D0%BE_-_Google_Art_Project.jpg",biografia:`
# Fyodor Dostoevsky
...
Dostoevsky's most famous works include *Crime and Punishment*, *The Idiot*, and *The Brothers Karamazov*. His novels are often considered to be some of the greatest works of literature ever written.
  `},{id:"virginia-woolf",nome:"Virginia Woolf",imagem:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQh89FBrmde-xjYGK2KamcDZgimuQwGPbjQhA&s",biografia:`
# Virginia Woolf
...
Her most famous works include *Mrs. Dalloway*, *To the Lighthouse*, and *Orlando*. Woolf's writing is often experimental and innovative, and she is considered one of the most influential writers of the 20th century.
  `},{id:"gabriel-garcia-marquez",nome:"Gabriel García Márquez",imagem:"https://upload.wikimedia.org/wikipedia/commons/0/0f/Gabriel_Garcia_Marquez.jpg",biografia:`
...
Márquez's most famous work is *One Hundred Years of Solitude*, which chronicles the history of the Buendía family. Other notable works include *Love in the Time of Cholera* and *Chronicle of a Death Foretold*.
  `},{id:"haruki-murakami",nome:"Haruki Murakami",imagem:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSAAY2X7dV_c7R1YLbCBH1OTHts_jHZ3j8ZZw&s",biografia:`
# Haruki Murakami
...
Murakami's most famous works include *Norwegian Wood*, *The Wind-Up Bird Chronicle*, and *Kafka on the Shore*. His books have been translated into many languages and have been widely acclaimed by critics.
  `},{id:"toni-morrison",nome:"Toni Morrison",imagem:"https://cdn.britannica.com/88/244188-050-F66D3342/Toni-Morrison-1993.jpg",biografia:`
# Toni Morrison
